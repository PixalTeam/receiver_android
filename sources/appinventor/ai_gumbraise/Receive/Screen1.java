...
public class Screen1 extends Form implements Runnable {
    ...
    static final SimpleSymbol Lit17 = ((SimpleSymbol) new SimpleSymbol("HorizontalArrangement1").readResolve());
    static final SimpleSymbol Lit18 = ((SimpleSymbol) new SimpleSymbol("AlignHorizontal").readResolve());
    static final IntNum Lit19 = IntNum.make(3);
    ...
    static final IntNum Lit22 = IntNum.make(16777215);
    ...
    static final SimpleSymbol Lit28 = ((SimpleSymbol) new SimpleSymbol("VerticalArrangement1").readResolve());
    ...
    static final SimpleSymbol Lit36 = ((SimpleSymbol) new SimpleSymbol("Button1$LongClick").readResolve());
    static final SimpleSymbol Lit37 = ((SimpleSymbol) new SimpleSymbol("LongClick").readResolve());
    static final SimpleSymbol Lit38 = ((SimpleSymbol) new SimpleSymbol("get-simple-name").readResolve());
    ...
    static final SimpleSymbol Lit50 = ((SimpleSymbol) new SimpleSymbol("dispatchGenericEvent").readResolve());
    static final SimpleSymbol Lit51 = ((SimpleSymbol) new SimpleSymbol("lookup-handler").readResolve());
    ...
    static {
        ...
        Lit4 = simpleSymbol;
        Lit35 = PairWithPosition.make(simpleSymbol, LList.Empty, "/tmp/1577910358808_0.4388497525813194-0/youngandroidproject/../src/appinventor/ai_gumbraise/Receive/Screen1.yail", 241739);
        int[] iArr = new int[2];
        iArr[0] = -15856114;
    ...
    public Screen1() {
        ...
        this.get$Mnsimple$Mnname = new ModuleMethod(frame2, 1, Lit38, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.onCreate = new ModuleMethod(frame2, 2, "onCreate", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.android$Mnlog$Mnform = new ModuleMethod(frame2, 3, Lit39, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnform$Mnenvironment = new ModuleMethod(frame2, 4, Lit40, 8194);
        this.lookup$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 5, Lit41, 8193);
        this.is$Mnbound$Mnin$Mnform$Mnenvironment = new ModuleMethod(frame2, 7, Lit42, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.add$Mnto$Mnglobal$Mnvar$Mnenvironment = new ModuleMethod(frame2, 8, Lit43, 8194);
        this.add$Mnto$Mnevents = new ModuleMethod(frame2, 9, Lit44, 8194);
        this.add$Mnto$Mncomponents = new ModuleMethod(frame2, 10, Lit45, 16388);
        this.add$Mnto$Mnglobal$Mnvars = new ModuleMethod(frame2, 11, Lit46, 8194);
        this.add$Mnto$Mnform$Mndo$Mnafter$Mncreation = new ModuleMethod(frame2, 12, Lit47, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.send$Mnerror = new ModuleMethod(frame2, 13, Lit48, FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.process$Mnexception = new ModuleMethod(frame2, 14, "process-exception", FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        this.dispatchEvent = new ModuleMethod(frame2, 15, Lit49, 16388);
        this.dispatchGenericEvent = new ModuleMethod(frame2, 16, Lit50, 16388);
        this.lookup$Mnhandler = new ModuleMethod(frame2, 17, Lit51, 8194);
        ...
        this.Button1$LongClick = new ModuleMethod(frame2, 27, Lit36, 0);
    }
        ...
        try {
            ...
            try {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit3, "Receive", Lit4);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit5, Lit6, Lit7);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit8, "56673328.png", Lit4);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit9, "zoom", Lit4);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit10, "portrait", Lit4);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit11, Boolean.TRUE, Lit12);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit13, "Fixed", Lit4);
                    runtime.setAndCoerceProperty$Ex(Lit0, Lit14, "Welcome", Lit4);
                    Values.writeValues(runtime.setAndCoerceProperty$Ex(Lit0, Lit15, Boolean.FALSE, Lit12), $result);
                } else {
                ...
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(Lit17, Lit27, Lit28, lambda$Fn5), $result);
                } else {
                    addToComponents(Lit17, Lit30, Lit28, lambda$Fn6);
                }
                this.Button1 = null;
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    Values.writeValues(runtime.addComponentWithinRepl(Lit28, Lit31, Lit32, lambda$Fn7), $result);
                } else {
                    addToComponents(Lit28, Lit34, Lit32, lambda$Fn8);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    runtime.addToCurrentFormEnvironment(Lit36, this.Button1$LongClick);
                } else {
                    addToFormEnvironment(Lit36, this.Button1$LongClick);
                }
                if (runtime.$Stthis$Mnis$Mnthe$Mnrepl$St != Boolean.FALSE) {
                    EventDispatcher.registerEventForDelegation((HandlesEventDispatching) runtime.$Stthis$Mnform$St, "Button1", "LongClick");
                } else {
                    addToEvents(Lit32, Lit37);
                }
                runtime.initRuntime();
            } catch (ClassCastException e) {
    ...
    static Object lambda3() {
        ...
        runtime.setAndCoerceProperty$Ex(Lit0, Lit13, "Fixed", Lit4);
        runtime.setAndCoerceProperty$Ex(Lit0, Lit14, "Welcome", Lit4);
        return runtime.setAndCoerceProperty$Ex(Lit0, Lit15, Boolean.FALSE, Lit12);
    }

    static Object lambda4() {
        runtime.setAndCoerceProperty$Ex(Lit17, Lit18, Lit19, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit17, Lit20, Lit21, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit17, Lit5, Lit22, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit17, Lit23, Lit24, Lit7);
        return runtime.setAndCoerceProperty$Ex(Lit17, Lit25, Lit24, Lit7);
    }
    ...
    static Object lambda6() {
        runtime.setAndCoerceProperty$Ex(Lit28, Lit18, Lit19, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit28, Lit20, Lit21, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit28, Lit5, Lit29, Lit7);
        runtime.setAndCoerceProperty$Ex(Lit28, Lit23, Lit24, Lit7);
        return runtime.setAndCoerceProperty$Ex(Lit28, Lit25, Lit24, Lit7);
    }
    ...
    static Object lambda8() {
        return runtime.setAndCoerceProperty$Ex(Lit32, Lit33, "56673328.png", Lit4);
    }
    ...
    public Object Button1$LongClick() {
        runtime.setThisForm();
        return runtime.callYailPrimitive(runtime.open$Mnanother$Mnscreen, LList.list1("Main"), Lit35, "open another screen");
    }
